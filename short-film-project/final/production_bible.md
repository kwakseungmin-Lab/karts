...
| **비율** | 2.39:1 (시네마스코프) |
| **촬영 포맷** | 4K, 24fps 기본 / 120~240fps 슬로우모션 |
...
| **녹음 방식** | 인티밋 마이킹(Intimate Miking) -- 마이크에 가까운 클로즈 녹음, 속삭이듯 하되 확신에 찬 |
...
### 촬영 스타일 (카메라 움직임, 렌즈 선택)

| 기법 | 적용 씬 | 장비/렌즈 | 효과 |
|------|---------|-----------|------|
| **핸드헬드** | 전투(씬 6, 8), 플래시백(씬 2, 3) | 와이드~미디엄 렌즈 | 긴장감, 리얼리즘, 혼란감 |
| **스테디캠/짐벌** | 대치(씬 5), 트래킹(씬 3 행군) | 35~85mm | 부드럽지만 살아있는 움직임 |
| **고정 삼각대** | 와이드샷(씬 4, 11, 12), 에필로그 | 와이드 렌즈 | 정적, 관조적 시선 |
| **텔레포토** | 안개 속 접근(씬 4) | 200mm+ | 안개 압축, 실루엣 효과 |
| **매크로** | 디테일 인서트(씬 1, 5, 7) | 매크로 렌즈 | ASMR 수준의 디테일 |
| **드론/크레인** | 프롤로그(씬 1), 에필로그(씬 12) | 초광각 | 스케일감, 버드아이 뷰 |

**슬로우모션 가이드라인:**
- 120fps: 무기 충돌 임팩트 (씬 6, 8)
- 240fps: 처형 순간 극도의 슬로우모션 (씬 9)
- **남용 금지** -- 선별적 사용으로 임팩트 극대화

**원테이크 계획:**
- 씬 8의 전반부 약 35초를 끊기지 않는 단일 숏으로 촬영
- 포아너 E3 2015 트레일러의 원테이크 전투 정신 계승
- 스테디캠 오퍼레이터의 사전 리허설 최소 3일 필요

### 조명 디자인

| 씬 | 조명 스타일 | 광원 | 효과 |
|----|------------|------|------|
| 씬 1 | 오버캐스트 자연광 | 태양 없음, 안개 산란 | 방향감 없는 플랫 라이팅 |
| 씬 2 | 키아로스쿠로 | 횃불 + 캠프파이어 | 강한 명암 대비, 카라바조 |
| 씬 3 | 오버캐스트 + 눈보라 | 확산광 | 바이킹 역광 실루엣 |
| 씬 4~5 | 안개 확산광 | 약한 자연광 | 몽환적 플랫 라이팅 |
| 씬 6~8 | 측면 자연광 | 아침 햇빛 비스듬히 | 검날 반사, 렌즈 플레어 자제 |
| 씬 9 | **백라이트** | 뒤에서 아침 햇빛 | **림라이트 실루엣** (핵심) |
| 씬 10 | 부드러운 자연광 | 아침 빛 고르게 | 그림자 없이 평온 |
| 씬 11~12 | 구름 전환 | 해가 가려짐 | 밝음 → 회색 전환 |

### VFX/후반 작업 계획

| VFX 항목 | 적용 씬 | 난이도 | 설명 |
|----------|---------|--------|------|
| 안개/연기 보강 | 전 씬 | 중 | 실제 안개 발생기 + CG 보강 |
| 불꽃/파편 | 씬 6, 8 | 중 | 검 충돌 시 불꽃 효과. 실물 보강 |
| 피 효과 | 씬 6, 7, 8 | 저 | 실용 혈액 팩 + 컬러 그레이딩 |
| 크레인업 확장 | 씬 12 | 고 | 드론 촬영 + CG 환경 확장 |
| 환경 확장(Matte Painting) | 씬 4, 12 | 고 | 고딕 성채, 파고다 배경 추가 |
| 군대 실루엣 | 씬 12 | 중 | 원경 군대 행렬 CG |
| 눈보라 | 씬 3 | 중 | 실제 인조 눈 + CG 눈보라 보강 |
| 컬러 그레이딩 | 전 씬 | 고 | 디새추레이션 + 색감 곡선 관리 |
| 프리즈프레임/슬로우모션 | 씬 8, 9 | 저 | 편집 단계 처리 |
...
| 소리 | 녹음 방식 | 적용 |
|------|-----------|------|
| 롱소드 vs 노다치 충돌 | 실제 검 녹음 기반 (폴리 스튜디오) | 씬 6, 8 |
| 패리 금속음 | 실제 금속 타격 + 저음 부스트 | 씬 6, 8 |
| 검 뽑는 소리 | 칼집 + 금속 마찰음, 길게 | 씬 4 (안개 속 울림) |
| 검 칼집에 넣는 소리 | 부드러운 금속음 + 나무/가죽 | 씬 10 |
| 검 돌에 닿는 소리 | **영화에서 가장 선명한 단일 효과음** | 씬 9 (정점) |
| 불꽃/파편 | 미세한 금속 파열음 | 씬 6, 8 충돌 순간 |
...
| 일차 | 씬 | 촬영 내용 | 예상 시간 |
|------|-----|-----------|-----------|
| **Day 1** | 씬 2 | 블랙스톤 야영지 플래시백 (야간 촬영, 비 효과) | 10시간 (야간) |
| **Day 2** | 씬 3 | 눈보라 산간 계곡 플래시백 (외부 로케이션) | 8시간 |
| **Day 3** | 씬 4, 5, 7 | 경계의 다리 -- 조우, 대치, 소강 (정적 씬) | 10시간 |
| **Day 4** | 씬 6, 8, 9 | 경계의 다리 -- 전투 시퀀스, 처형 순간 (액션 씬) | 12시간 |
| **Day 5** | 씬 1, 10, 11, 12 | 전장 폐허(오프닝), 화해/에필로그, 드론 촬영 | 10시간 |

**추가 일정:**
- 사전 리허설: 전투 안무 3일 (스턴트 코디네이터 포함)
- 로케이션 헌팅: 2일
- VO 녹음: 1일 (아폴리온 + 블랙스톤 지휘관)
...
| 장비 | 용도 |
|------|------|
| 메인 카메라: RED V-RAPTOR 또는 ARRI ALEXA Mini LF | 4K, 120fps 슬로우모션 지원 |
| 하이스피드 카메라: Phantom Flex4K | 240fps 극도의 슬로우모션 (씬 9) |
| 렌즈 세트: 시네마 프라임 (24, 35, 50, 85mm) | 기본 촬영 |
| 텔레포토: 200mm+ | 씬 4 안개 압축 효과 |
| 매크로 렌즈 | 씬 1, 5 디테일 인서트 |

#### 안정화 & 이동

| 장비 | 용도 |
|------|------|
| 스테디캠/짐벌 (DJI Ronin 4D 또는 Steadicam) | 대치, 트래킹 숏 |
| 삼각대 (Sachtler, O'Connor) | 와이드샷 고정 |
| 드론 (DJI Inspire 3) | 씬 1, 12 조감 촬영 |
| 크레인/지브 | 씬 12 수직 상승 |
...
| 장비 | 용도 |
|------|------|
| 대형 실크/디퓨전 (12x12, 20x20) | 안개 씬 확산광 |
| LED 패널 (ARRI SkyPanel) | 보조 자연광 |
| 텅스텐 프레넬 | 씬 2 횃불빛 보강 |
| 실제 횃불 세트 (6~10개) | 씬 2 실제 광원 |
| 반사판 (대형) | 씬 9 백라이트 보강 |
...
| 장비 | 용도 |
|------|------|
| 안개 발생기 (헤이즈 머신) 2~3대 | 전 외부 씬 |
| 레인 바(Rain Bar) 시스템 | 씬 2 비 효과 |
| 인조 눈 발생기 | 씬 3 눈보라 |
| 혈액 팩 / 튜브 시스템 | 씬 6, 7, 8 전투 피 |

#### 사운드

| 장비 | 용도 |
|------|------|
| 붐 마이크 (Sennheiser MKH 416) | 현장 수음 |
| 와이어리스 라벨리어 | 배우 호흡, 갑옷 소리 |
| 앰비언스 레코더 (Sound Devices MixPre) | 자연음 녹음 |
| 포터블 레코더 | 폴리(금속 충돌, 갑옷 소리) 현장 수음 |

### 캐스팅 요구사항

| 역할 | 요구 조건 | 비고 |
|------|-----------|------|
| **에이든** | 남성, 30대 중반, 180cm+, 넓은 어깨 야윈 체격. 무술/스턴트 경험 필수. 대사 없음 -- 눈 연기와 체형 연기 위주 | 전투 안무 3일 리허설 필요 |
| **카게마사** | 남성, 40대 초반, 175cm, 다부진 근육질. 검술/무술 경험 우대. 대사 없음 -- 절제된 표정 연기 | 동양인 배우 또는 유사 외형 |
| **블랙스톤 지휘관** | 남성, 체격 큰 배우. 얼굴 노출 없음(투구). 대사 1줄. 위압적 실루엣 | 씬 2만 출연 (1일) |
| **아폴리온 (VO)** | 여성, 낮고 차가우며 지적인 목소리. 성우 또는 배우 | 녹음 1일 |
| **사무라이 정찰대** | 엑스트라 4~5명. 동양인 외형 우대. 기본 무술 동작 가능 | 씬 3만 출연 |
| **블랙스톤 병사** | 엑스트라 5~8명. 검은 갑옷 착용. 배경 역할 | 씬 2만 출연 |
| **바이킹 습격대** | 엑스트라/스턴트맨 5~6명. 실루엣 위주 | 씬 3만 출연 |

### 로케이션 요구사항

| 로케이션 | 요구 사항 | 적합 후보 |
|----------|-----------|-----------|
| **경계의 다리** (메인) | 석조 아치 다리 또는 유사 구조물. 양쪽에 다른 풍경 배치 가능. 안개 효과 적용 가능한 고도/지형 | 자연 석조 다리 + CG 보강 / 스튜디오 세트 |
| **블랙스톤 야영지** | 고딕 성채 느낌의 석조 벽. 야간 촬영 가능. 비 효과 설치 공간 | 중세 성채 보존 지역 / 야외 세트 |
| **산간 계곡** | 넓은 평지 + 산 배경. 인조 눈 설치 가능 | 강원도 산간 / 겨울 로케이션 |
| **전장 폐허** | 넓은 평지. 소품(깃발, 검) 배치 공간. 드론 촬영 가능 | 야외 빈 필드 + 미술팀 세팅 |
...
| 항목 | 상세 | 수량 |
|------|------|------|
| 에이든 갑옷 세트 | 부분 판금갑 + 체인메일 + 가죽. 긁힌 블랙스톤 문장 디테일. 풍화 처리 | 2벌 (메인 + 스턴트) |
| 에이든 투구 | 바르부타 형태, 얼굴 하부 개방 | 2개 |
| 카게마사 갑옷 세트 | 남색 오요로이, 금박 황실 문양(일부 벗겨짐), 소데, 대나무+래커 | 2벌 (메인 + 스턴트) |
| 카게마사 투구 | 카부토 + 반월형 마에다테 | 2개 |
| 카게마사 멘포 | 귀신 얼굴 반면 가면. **떨어뜨릴 수 있도록 자석/핀 장치** | 3개 (촬영+예비) |
| 블랙스톤 지휘관 갑옷 | 검은 판금갑 + 늑대 문양 투구 + 플람베르주 | 1벌 |
| 블랙스톤 병사 갑옷 | 검은 갑옷 5~8벌 (엑스트라용) | 5~8벌 |
| 사무라이 정찰대 갑옷 | 중급 사무라이 갑옷 4~5벌 | 4~5벌 |
| 바이킹 습격대 의상 | 가죽 + 모피, 쌍수 도끼 소품 | 5~6벌 |

#### 주요 무기 소품

| 항목 | 상세 | 수량 |
|------|------|------|
| 에이든 롱소드 | 전체 120cm, 묵직한 크로스가드, 칼날 룬 각인 마모 | 3자루 (금속+고무+CG마커) |
| 카게마사 노다치 | 150cm, 곡선 장도, 쓰바에 벚꽃 문양 | 3자루 |
| 블랙스톤 지휘관 플람베르주 | 화염검 형태 | 1자루 |
| 바이킹 쌍수 도끼 | 버서커 스타일 손도끼 | 10개 |
| 전장 소품 (씬 1) | 부러진 검, 찢어진 깃발(3진영), 쓰러진 갑옷 조각 | 다수 |

### VFX 작업 리스트

| 작업 | 씬 | 상세 | 일정 |
|------|-----|------|------|
| 안개 CG 보강 | 전 씬 | 실제 안개 + CG 레이어 합성 | 2주 |
| 환경 확장 (Matte Painting) | 씬 4, 12 | 고딕 성채, 파고다, 습지 배경 | 3주 |
| 검 충돌 불꽃/파편 | 씬 6, 8 | 실물 보강 CG | 1주 |
| 군대 실루엣 | 씬 12 | 원경 행군 군대 CG | 1주 |
| 눈보라 CG 보강 | 씬 3 | 인조 눈 + CG 눈보라 | 1주 |
| 피 효과 보강 | 씬 6, 7, 8 | 실용 혈액 + CG 보강 | 3일 |
| 크레인업 확장 | 씬 12 | 드론 to 버드아이 CG 전환 | 1주 |
| 컬러 그레이딩 | 전 씬 | 디새추레이션 + 색감 곡선 | 2주 |

### 후반 작업 일정

| 단계 | 작업 | 기간 |
|------|------|------|
| 편집 (1차) | 러프컷 조립, 타이밍 조정 | 2주 |
| 편집 (2차) | 파인컷, 슬로우모션 타이밍 정밀 조정 | 1주 |
| VFX | 안개, 환경 확장, 불꽃, 군대 CG | 4주 (병렬) |
| 컬러 그레이딩 | 전체 색감 곡선, LUT 적용, 씬별 미세 조정 | 2주 |
| 음악 작곡/편곡 | 오케스트라 + 민족악기 녹음 | 3주 |
| 사운드 디자인 | 폴리(SFX), 앰비언스, 믹싱 | 2주 |
| 최종 믹싱 | 음악 + SFX + VO + 대사 밸런싱 | 1주 |
| DCP/마스터링 | 극장용 DCP 또는 온라인 마스터 | 3일 |

**총 후반 작업: 약 8~10주** (VFX와 음악을 병렬 진행 시)

### 예상 예산 범위

| 항목 | 예상 범위 (KRW) | 비고 |
|------|-----------------|------|
| 프리프로덕션 | 500만~1,000만 | 로케이션 헌팅, 스토리보드, 안무 리허설 |
| 의상/소품/특수분장 | 2,000만~4,000만 | 갑옷 제작이 최대 비용 항목 |
| 촬영 (5일) | 3,000만~5,000만 | 장비 렌탈, 크루 인건비, 로케이션 비용 |
| 출연료 | 1,000만~2,000만 | 주연 2명 + 단역 + 엑스트라 + 성우 |
| VFX | 2,000만~4,000만 | 환경 확장, 안개, CG 보강 |
| 음악/사운드 | 1,500만~3,000만 | 작곡, 오케스트라 녹음, SFX, 믹싱 |
| 후반 편집/그레이딩 | 500만~1,000만 | 편집, 컬러 그레이딩, 마스터링 |
| 기타/예비비 | 500만~1,000만 | 교통, 식비, 보험, 예비 |
| **총 예상** | **약 1.1억~2.1억원** | 인디 단편영화 수준 |

> **비용 절감 옵션**: 갑옷을 기존 코스프레/재연용 갑옷 렌탈로 대체 시 의상 비용 50% 절감 가능. VFX를 미니멀하게 처리(안개만 CG, 배경은 실제 로케이션 활용) 시 1억 이하 가능.
