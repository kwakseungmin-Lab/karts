...
| **비율** | 2.39:1 (시네마스코프) |
| **제작 방식** | AI 이미지/영상 생성 (Midjourney + Runway Gen-3 / Kling AI) |
...
**AI 영상화 방식:**
- 씬당 핵심 프레임을 Midjourney / Stable Diffusion으로 이미지 생성 (스토리보드 역할)
- Runway Gen-3 Alpha 또는 Kling AI로 이미지-to-비디오 변환 (클립당 3~5초)
...
| 작업 | 적용 씬 | AI 도구 | 방법 |
|------|---------|---------|------|
| 키프레임 이미지 생성 | 전 씬 | Midjourney v6 / DALL-E 3 | 씬별 핵심 프레임 정밀 프롬프트 생성 |
| 이미지 → 영상 변환 | 전 씬 | Runway Gen-3 Alpha / Kling AI | 스틸 이미지를 3~5초 클립으로 애니메이션화 |
| 안개/대기감 | 전 씬 | Runway 모션 브러시 | `fog, mist, atmospheric haze` 프롬프트 강화 |
| 전투 액션 클립 | 씬 6, 8 | Kling AI / Pika 2.0 | 전투 동작 연속 클립 생성 |
| 슬로우모션 처리 | 씬 6, 8, 9 | Topaz Video AI / DAIN | AI 프레임 보간으로 슬로우모션 효과 |
| 환경 배경 생성 | 씬 4, 12 | Midjourney → Runway | 성채, 파고다, 습지 배경 이미지 생성 후 영상화 |
| 군대 실루엣 | 씬 12 | Runway / Kling AI | 원경 군대 행렬 클립 생성 |
| 눈보라 효과 | 씬 3 | Runway Gen-3 | `blizzard, snowstorm, whiteout` 프롬프트 |
| 컬러 그레이딩 | 전 씬 | DaVinci Resolve (AI LUT) | 디새추레이션 + 씬별 색감 곡선 |
| 클립 편집 & 조립 | 전체 | DaVinci Resolve / Premiere Pro | AI 생성 클립 연결, 타이밍 및 전환 조정 |
...
Midjourney로 씬별 핵심 이미지 생성 → 캐릭터/조명/색감 일관성 검수 → 스토리보드 확정

[Stage 3] 영상 클립 생성 (3~4주)
Runway Gen-3 / Kling AI로 이미지 → 영상 변환 → 슬로우모션 프레임 보간 → 클립별 검수
...
| 도구 | 용도 | 플랜 |
|------|------|------|
| **Midjourney v6** | 캐릭터/배경 키프레임 이미지 생성 | Pro ($60/월) |
| **Stable Diffusion + ComfyUI** | 캐릭터 일관성 유지, 배치 생성 | 로컬 무료 |
| **Runway Gen-3 Alpha** | 이미지 → 영상 변환, 대기 효과 | Standard ($15/월) |
| **Kling AI** | 전투 액션 클립 생성 | Pro ($29/월) |
| **Pika 2.0** | 보조 영상 생성 | Plus ($8/월) |
| **Topaz Video AI** | 슬로우모션 AI 프레임 보간 | 일회성 구매 ($299) |
...
| 도구 | 용도 |
|------|------|
| **DaVinci Resolve 19** | 편집, 컬러 그레이딩, 믹싱 (무료) |
...
| 주차 | 작업 | 담당 도구 |
|------|------|-----------|
| 1주차 | 캐릭터 마스터 이미지 생성 및 확정 | Midjourney, Stable Diffusion |
| 2주차 | 배경/환경 키프레임 생성 | Midjourney |
| 3~4주차 | 씬 1~6 키프레임 이미지 생성 | Midjourney |
| 5~6주차 | 씬 7~12 키프레임 이미지 생성 | Midjourney |
| 5~7주차 (병렬) | AI 음악/SFX 생성 | Suno AI, ElevenLabs |
| 6~8주차 | 이미지 → 영상 변환 (전 씬) | Runway Gen-3, Kling AI |
| 8~9주차 | 슬로우모션 처리, 클립 편집 | Topaz Video AI, DaVinci |
| 9~10주차 | 컬러 그레이딩, 사운드 믹싱, 마스터링 | DaVinci Resolve |

### 예상 비용 (AI 도구 기준)

| 항목 | 월정액/비용 (USD) | 비고 |
|------|-----------------|------|
| Midjourney Pro | $60/월 × 2개월 | 키프레임 대량 생성 |
| Runway Standard | $15/월 × 2개월 | 영상 변환 |
| Kling AI Pro | $29/월 × 2개월 | 전투 액션 클립 |
| Pika Plus | $8/월 × 1개월 | 보조 영상 |
| Topaz Video AI | $299 (일회성) | 슬로우모션 보간 |
| Suno Pro | $8/월 × 2개월 | BGM 생성 |
| ElevenLabs Starter | $5/월 × 1개월 | VO + SFX |
| Adobe CC | $55/월 × 3개월 | Premiere + After Effects |
| DaVinci Resolve | 무료 | 편집/그레이딩 |
