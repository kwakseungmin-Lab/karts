"""씬01 컷01 영상 생성 스크립트 — Sora sora-2, 1280x720 → 1920x1080 업스케일."""
...
PROMPT = (
    ...
    "Camera motion: Slow aerial descent from bird's eye toward ground level, "
    "crows scatter upward as camera descends."
)
...
def download_video(video_id: str, api_key: str) -> None:
    # 다운로드 엔드포인트: /content (not /content/video)
