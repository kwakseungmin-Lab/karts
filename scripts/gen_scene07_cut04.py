"""Generate scene07_cut04.mp4 via Sora sora-2 then upscale to 1920x1080."""
...
INPUT_IMAGE = "/Users/ksm2761/karts/short-film-project/final/frames/scene07_cut04_hd.png"
RAW_OUTPUT = "/tmp/scene07_cut04_raw.mp4"
FINAL_OUTPUT = "/Users/ksm2761/karts/short-film-project/final/videos/scene07_cut04.mp4"
# Sora sora-2 currently supports 720x1280 and 1280x720 only
SIZE = "1280x720"
SORA_W, SORA_H = 1280, 720
SECONDS = "8"
PROMPT = (
    "Cinematic alternating tight close-ups, cross-cutting between two warriors' faces — "
    "first Aiden (medieval knight, scarred face with vertical scar above left eye, brown hair, "
    "exhausted eyes registering sudden recognition, gauntleted hand unconsciously touching his own "
    "damaged left pauldron where a crest was scratched away) then Kagemasa (samurai, 40s, long black hair "
    "in topknot, deep composed eyes with subtle understanding, giving the faintest deliberate nod), "
    "both warriors still holding weapons but the aggression momentarily suspended, morning fog behind, "
...
def main() -> None:
    ...
    log.info("Resizing input image 1920x1080 -> %dx%d (Sora input)", SORA_W, SORA_H)
    data_url = build_data_url(INPUT_IMAGE, SORA_W, SORA_H)
